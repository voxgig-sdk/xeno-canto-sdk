...
class XenoCantoTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = XenoCantoTestRunner.getenv("PROJECTNAME_TEST_LIVE")
        override = XenoCantoTestRunner.getenv("PROJECTNAME_TEST_OVERRIDE")
        ...
        explain = XenoCantoTestRunner.getenv("PROJECTNAME_TEST_EXPLAIN")
