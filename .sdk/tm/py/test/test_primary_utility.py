...
from projectname_sdk import XenoCantoSDK
from projectname_sdk.core.spec import XenoCantoSpec
from projectname_sdk.core.result import XenoCantoResult
from projectname_sdk.core.response import XenoCantoResponse
from projectname_sdk.core.operation import XenoCantoOperation
from projectname_sdk.core.error import XenoCantoError
from projectname_sdk.core import helpers
from projectname_sdk.feature.base_feature import XenoCantoBaseFeature
...
def _err_from_map(m):
    ...
    if msg == "":
        return None
    code = m.get("code", "")
    return XenoCantoError(code, msg)
...
class TestPrimaryUtility:
    ...
    def test_feature_init_basic(self):
        init_client = XenoCantoSDK.test(None, None)
        ...
        class TestInitFeature(XenoCantoBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "initfeat"
                self.active = True
    ...
    def test_feature_init_inactive(self):
        ...
        class TestInitFeatureInactive(XenoCantoBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "nofeat"
                self.active = False
    ...
    def test_make_result_no_result(self):
        ...
        utility = client._utility
        ctx = _make_test_full_ctx(client, utility)
        ctx.spec = XenoCantoSpec({"step": "start"})
        ctx.result = None
    ...
    def test_make_spec_basic(self):
        ...
        spec_client = XenoCantoSDK.test(None, setup_opts)
    ...
    def test_prepare_auth_basic(self):
        ...
        auth_client = XenoCantoSDK.test(None, setup_opts)
