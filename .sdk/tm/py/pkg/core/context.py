...
from projectname_sdk.core.control import XenoCantoControl
...
class XenoCantoContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        if isinstance(sp, XenoCantoSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, XenoCantoResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, XenoCantoResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return XenoCantoError(code, msg, self)
