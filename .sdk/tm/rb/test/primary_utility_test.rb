...
class PrimaryUtilityTest < Minitest::Test
  ...
  def setup
    @runner = XenoCantoOmni.make_runner(TEST_JSON_FILE, XenoCantoSDK.test(nil, nil))
  ...
  def test_make_point_basic
    ...
    subject = lambda do |ctx|
      ...
      err.nil? ? point : XenoCantoOmni.errify(err)
    end
