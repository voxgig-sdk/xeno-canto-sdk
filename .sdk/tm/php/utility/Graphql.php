...
class XenoCantoGraphql
{
    ...
    // equivalent.
    public static function body(XenoCantoContext $ctx): mixed
    {
    ...
    public static function errors(XenoCantoContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
