...
// XenoCanto SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class XenoCantoMakeRequest
{
    public static function call(XenoCantoContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new XenoCantoResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new XenoCantoResponse($fetched);
        } else {
