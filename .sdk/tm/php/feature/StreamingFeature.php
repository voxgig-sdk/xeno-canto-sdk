...
// XenoCanto SDK streaming feature
...
class XenoCantoStreamingFeature extends XenoCantoBaseFeature
{
    ...
    private function _iterate(XenoCantoResult $result): \Generator
    {
    ...
    private function _streamable(XenoCantoContext $ctx): bool
    {
