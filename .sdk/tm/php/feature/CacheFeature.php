...
class XenoCantoCacheFeature extends XenoCantoBaseFeature
{
    ...
    private function _through(XenoCantoContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
