...
// XenoCanto SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class XenoCantoTestFeature extends XenoCantoBaseFeature
{
    ...
    public function init(XenoCantoContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (XenoCantoContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
            ...
            if ($op->name === 'load') {
                ...
                $id = XenoCantoParam::call($fctx, 'id');
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (XenoCantoContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(XenoCantoContext $ctx, $op, $args): array
    {
