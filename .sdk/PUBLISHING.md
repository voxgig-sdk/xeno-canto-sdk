...
|---|---|---|
| `ts/` | @voxgig-sdk/xeno-canto-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/xeno-canto-sdk \
      --repository voxgig-sdk/xeno-canto-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/xeno-canto-sdk` shows it, and
`npm trust revoke @voxgig-sdk/xeno-canto-sdk --id=<id>` removes it.
