...
local XenoCantoSDK = {}
XenoCantoSDK.__index = XenoCantoSDK
...
XenoCantoSDK._make_feature = _make_feature


function XenoCantoSDK.new(options)
  local self = setmetatable({}, XenoCantoSDK)
  self.mode = "live"
  self.features = {}
  self.options = nil
...
function XenoCantoSDK:options_map()
...
function XenoCantoSDK:get_utility()
  return Utility.copy(self._utility)
end


function XenoCantoSDK:get_root_ctx()
  return self._rootctx
end


function XenoCantoSDK:prepare(fetchargs)
...
function XenoCantoSDK:direct(fetchargs)
...
-- by passing it.
function XenoCantoSDK:_raw_request(fetchargs)
  local utility = self._utility
...
function XenoCantoSDK:graphql(query, variables, ctrl)
  ...
  if type(errors) == "table" and 0 < #errors then
    ...
    res.ok = false
    res.err = "XenoCantoSDK: graphql: " .. msg
    res.graphql = errors
  end
...
function XenoCantoSDK:Recording(data)
...
function XenoCantoSDK.test(testopts, sdkopts)
  sdkopts = sdkopts or {}
  ...
  local sdk = XenoCantoSDK.new(sdkopts)
  sdk.mode = "test"
