# XenoCanto SDK Recording entity
...
class RecordingEntity
  ...
  def data_set(args)
    if args
      @_data = XenoCantoHelpers.to_map(VoxgigStruct.clone(args)) || {}
  ...
  def match_set(args)
    if args
      @_match = XenoCantoHelpers.to_map(VoxgigStruct.clone(args)) || {}
  ...
  # @return [Array<Recording>, Array] the matching Recording items; raises XenoCantoError on failure
