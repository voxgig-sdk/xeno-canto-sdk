...
class RecordingEntityTest < Minitest::Test
  ...
  def test_stream
    ...
    base = XenoCantoSDK.test(seed, nil)
  ...
  def test_basic_flow
    ...
    if setup[:synthetic_only]
      skip "live entity test uses synthetic IDs from fixture — set XENO_CANTO_TEST_RECORDING_ENTID JSON to run live"
      return
    end
    client = setup[:client]
...
def recording_basic_setup(extra)
  ...
  entid_env_raw = ENV["XENO_CANTO_TEST_RECORDING_ENTID"]
