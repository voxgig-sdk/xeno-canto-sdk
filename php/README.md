...
The PHP SDK for the XenoCanto API. Provides an entity-oriented interface using PHP conventions.
...
```php
[$result, $err] = $client->Recording(null)->list(null, null);
...
[$result, $err] = $client->XenoCanto(null)->load(
    ["id" => "test01"], null
);
