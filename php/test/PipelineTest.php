...
{
    private static function utility(): XenoCantoUtility
    {
        return new XenoCantoUtility();
    }
    ...
    private static function ctx(array $over = []): XenoCantoContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new XenoCantoContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new XenoCantoOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof XenoCantoError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new XenoCantoOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = XenoCantoMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new XenoCantoOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = XenoCantoMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new XenoCantoOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = XenoCantoMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new XenoCantoSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = XenoCantoMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            'spec' => null,
            'response' => new XenoCantoResponse([]),
            'result' => new XenoCantoResult([]),
        ]);
        [, $err] = XenoCantoMakeResponse::call($ctx);
        $this->assertSame('response_no_spec', self::code($err));

        $ctx = self::ctx([
            'spec' => new XenoCantoSpec([]),
            'response' => null,
            'result' => new XenoCantoResult([]),
        ]);
        [, $err] = XenoCantoMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new XenoCantoSpec(['step' => 's']),
            'response' => new XenoCantoResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new XenoCantoResult([]),
        ]);
        [, $err] = XenoCantoMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new XenoCantoSpec(['step' => 's']),
            'response' => new XenoCantoResponse(self::resp(200, ['v' => 1])),
            'result' => new XenoCantoResult([]),
        ]);
        [, $err] = XenoCantoMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new XenoCantoSpec(['step' => 's']),
            'response' => new XenoCantoResponse(self::resp(200, ['v' => 2])),
            'result' => new XenoCantoResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        XenoCantoMakeResponse::call($ctx);
    ...
    {
        $preset = new XenoCantoResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new XenoCantoSpec([]),
            'response' => new XenoCantoResponse([]),
            'result' => new XenoCantoResult([]),
        ...
        [$got, $err] = XenoCantoMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new XenoCantoResult([])]);
        [, $err] = XenoCantoMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new XenoCantoSpec([]), 'result' => null]);
        [, $err] = XenoCantoMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new XenoCantoSpec(['step' => 's']),
            'result' => new XenoCantoResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new XenoCantoOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = XenoCantoMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new XenoCantoSpec(['step' => 's']),
            'result' => new XenoCantoResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new XenoCantoOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = XenoCantoMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new XenoCantoResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new XenoCantoSpec([]),
            'result' => new XenoCantoResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = XenoCantoMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = XenoCantoMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new XenoCantoError('boom', 'boom');
        $utility->fetcher = function (XenoCantoContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new XenoCantoSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = XenoCantoMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (XenoCantoContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = XenoCantoMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(XenoCantoResponse::class, $response);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (XenoCantoContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new XenoCantoSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = XenoCantoMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new XenoCantoResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new XenoCantoSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = XenoCantoMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = XenoCantoMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = XenoCantoMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new XenoCantoResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, XenoCantoDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new XenoCantoResult(['ok' => false])]);
        $this->expectException(XenoCantoError::class);
        XenoCantoDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new XenoCantoResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', XenoCantoMakeError::call($ctx, null));
    }
    ...
    public function test_make_error_records_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->throw_err = false;
        $ctx->ctrl->explain = ['on' => true];
        XenoCantoMakeError::call($ctx, null);
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new XenoCantoBaseFeature();
        $b = new XenoCantoBaseFeature();
        XenoCantoFeatureAdd::call($ctx, $a);
        XenoCantoFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): XenoCantoBaseFeature
    {
        $f = new XenoCantoBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        XenoCantoFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?array $headers): XenoCantoContext
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new XenoCantoSpec(['headers' => $headers]),
        ]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = XenoCantoPrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new XenoCantoResponse(['headers' => null]),
            'result' => new XenoCantoResult([]),
        ]);
        XenoCantoResultHeaders::call($ctx);
