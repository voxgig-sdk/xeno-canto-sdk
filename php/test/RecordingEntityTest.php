...
class RecordingEntityTest extends TestCase
{
    ...
    public function test_stream(): void
    {
        ...
        $base = XenoCantoSDK::test($seed, null);
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set XENO_CANTO_TEST_RECORDING_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
...
function recording_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("XENO_CANTO_TEST_RECORDING_ENTID");
