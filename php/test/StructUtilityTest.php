...
// XenoCanto SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = XenoCantoOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(XenoCantoOmni::structfix($now, Struct::undef()))
                        !== json_encode(XenoCantoOmni::structfix($val, Struct::undef()))) {
