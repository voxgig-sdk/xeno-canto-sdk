...
// XenoCanto SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (XenoCantoSDK::test)
...
{
    private const SDK_CLASS = 'XenoCantoSDK';
    ...
    private const SDK_BASE = 'xenocanto_sdk';
