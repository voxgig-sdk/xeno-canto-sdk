...
class RecordingEntity
{
    ...
    {
        if ($args) {
            $this->_data = XenoCantoHelpers::to_map(Struct::clone($args)) ?? [];
    ...
    {
        if ($args) {
            $this->_match = XenoCantoHelpers::to_map(Struct::clone($args)) ?? [];
     ...
     *   the SDK boundary; throws XenoCantoError on failure (item-5 convention).
     */
