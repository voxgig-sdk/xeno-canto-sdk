...
class XenoCantoRbacFeature extends XenoCantoBaseFeature
{
    ...
    private function _required(XenoCantoContext $ctx): ?string
    {
    ...
    private function _reject(XenoCantoContext $ctx, string $required): void
    {
    ...
    private function _track(XenoCantoContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
