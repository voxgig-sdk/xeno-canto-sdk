...
class XenoCantoProxyFeature extends XenoCantoBaseFeature
{
    ...
    public function init(XenoCantoContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (XenoCantoContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
