...
// XenoCanto SDK ratelimit feature
...
class XenoCantoRatelimitFeature extends XenoCantoBaseFeature
{
    ...
    private function _acquire(XenoCantoContext $ctx): void
    {
    ...
    private function _track(XenoCantoContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
