...
// XenoCanto SDK clienttrack feature
...
class XenoCantoClienttrackFeature extends XenoCantoBaseFeature
{
    ...
    public function PostConstruct(XenoCantoContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'XenoCanto-SDK';
