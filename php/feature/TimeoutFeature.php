...
class XenoCantoTimeoutFeature extends XenoCantoBaseFeature
{
    ...
    private function _with_timeout(XenoCantoContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(XenoCantoContext $_ctx, float $ms): void
    {
        $client = $this->client;
