...
class XenoCantoFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; XenoCantoSDK/1.0)';
    ...
    public static function call(XenoCantoContext $ctx, string $fullurl, array $fetchdef): array
    {
