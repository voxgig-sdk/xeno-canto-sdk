...
function envOverride(m) {
    if ('TRUE' === process.env.XENO_CANTO_TEST_LIVE ||
        'TRUE' === process.env.XENO_CANTO_TEST_OVERRIDE) {
    ...
    m.XENO_CANTO_TEST_EXPLAIN = process.env.XENO_CANTO_TEST_EXPLAIN || m.XENO_CANTO_TEST_EXPLAIN;
    return m;
}
