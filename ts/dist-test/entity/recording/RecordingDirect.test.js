...
(0, node_test_1.describe)('RecordingDirect', async () => {
    ...
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.XenoCantoSDK({
...
function liveScenariosActive() { return false && process.env.XENO_CANTO_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.XenoCantoSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
            apikey: env.XENO_CANTO_APIKEY,
        }));
        let idmap = env['XENO_CANTO_TEST_RECORDING_ENTID'];
    ...
    const client = new __1.XenoCantoSDK({
        base: 'http://localhost:8080',
