...
type Args struct {
	Entity string         `json:"entity" jsonschema:"recording"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.XenoCantoSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "xeno-canto_list",
		Description: "List records from XenoCanto. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "xeno-canto_load",
		Description: "Load a single record from XenoCanto. " +
...
func runOp(client *sdk.XenoCantoSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.XenoCantoSDK, name string) (sdk.XenoCantoEntity, error) {
