...
## Install
```bash
go get github.com/voxgig-sdk/xeno-canto-sdk
```
...
```bash
go mod edit -replace github.com/voxgig-sdk/xeno-canto-sdk=../path/to/github.com/voxgig-sdk/xeno-canto-sdk
```
...
```
github.com/voxgig-sdk/xeno-canto-sdk/
...
The root package (`github.com/voxgig-sdk/xeno-canto-sdk`) re-exports everything needed
