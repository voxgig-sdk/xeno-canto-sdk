...
recording, err := client.Recording(nil).Load(
    map[string]any{"id": "test01"}, nil,
)
if err != nil {
    panic(err)
}
fmt.Println(recording) // the loaded mock data
```
...
slice):
    ...
    recording, err := client.Recording(nil).Load(map[string]any{"id": "example_id"}, nil)
    if err != nil { /* handle */ }
...
recording.Load(map[string]any{"id": "example_id"}, nil)
