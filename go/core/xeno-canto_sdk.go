...
func (sdk *XenoCantoSDK) OptionsMap() map[string]any {
...
func (sdk *XenoCantoSDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *XenoCantoSDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *XenoCantoSDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *XenoCantoSDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *XenoCantoSDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *XenoCantoSDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("XenoCantoSDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *XenoCantoSDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *XenoCantoSDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("XenoCantoSDK: graphql: %s", msg)
		res["graphql"] = errors
	}
