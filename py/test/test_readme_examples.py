# XenoCanto SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions XenoCantoSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both XenoCantoSDK(...) and XenoCantoSDK.test(...) become
#      XenoCantoSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "xenocanto_sdk"
_SDK_CLASS = "XenoCantoSDK"
