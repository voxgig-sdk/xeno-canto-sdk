...
class XenoCantoTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = XenoCantoTestRunner.getenv("XENO_CANTO_TEST_LIVE")
        override = XenoCantoTestRunner.getenv("XENO_CANTO_TEST_OVERRIDE")
        ...
        explain = XenoCantoTestRunner.getenv("XENO_CANTO_TEST_EXPLAIN")
