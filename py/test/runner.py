...
class XenoCantoTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = XenoCantoTestRunner.getenv("XENOCANTO_TEST_LIVE")
        override = XenoCantoTestRunner.getenv("XENOCANTO_TEST_OVERRIDE")
        ...
        explain = XenoCantoTestRunner.getenv("XENOCANTO_TEST_EXPLAIN")
