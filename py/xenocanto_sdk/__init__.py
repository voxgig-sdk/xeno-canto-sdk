...
from xenocanto_sdk.utility import register

# Load features
from xenocanto_sdk.feature.base_feature import XenoCantoBaseFeature
from xenocanto_sdk.features import _has_feature, _make_feature
...
class XenoCantoSDK:
    ...
    def __init__(self, options=None):
        ...
        utility = XenoCantoUtility()
        self._utility = utility

        from xenocanto_sdk.config import shared_config
    ...
    def get_utility(self):
        return XenoCantoUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("XenoCantoSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Recording(self, data=None) -> "RecordingEntity":
        ...
        from xenocanto_sdk.entity.recording_entity import RecordingEntity
